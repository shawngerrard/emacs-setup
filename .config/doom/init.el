...
(setq org-roam-capture-templates
      '(("d" "default" plain
         ...
         :unnarrowed t)
        ("b" "blender tips" plain (file "~/documents/second-brain/templates/blendertips.org")
          :if-new (file+head "%<%Y%m%d%H%M%S>-${slug}.org" "#+Title: ${title}\n")
          :unnarrowed t)
        ("c" "characters" plain (file "~/documents/second-brain/templates/character.org")
          :if-new (file+head "%<%Y%m%d%H%M%S>-${slug}.org" "#+Title: ${title}\n")
          :unnarrowed t)
        ("p" "exo-planets" plain (file "~/documents/second-brain/templates/exoplanet.org")
          :if-new (file+head "%<%Y%m%d%H%M%S>-${slug}.org" "#+Title: ${title}\n")
          :unnarrowed t)
        ("s" "scenes" plain (file "~/documents/second-brain/templates/scene.org")
          :if-new (file+head "%<%Y%m%d%H%M%S>-${slug}.org" "#+Title: ${title}\n")
          :unnarrowed t)
        )
      )
